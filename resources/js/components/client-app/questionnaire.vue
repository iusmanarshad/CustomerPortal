<template>
    <div class="container mx-auto mt-3">
        <FormWizard @on-complete="onComplete" color="#094899">
            <TabContent title="Contact Details" icon="fa fa-user" :before-change="beforePersonalTabSwitch">
                <div class="row row-sm mb-3">
                    <div class="col-md-5 col-lg-4">
                        <label for="firstname" class="form-label">Firstname: <span class="tx-danger">*</span></label>
                        <input type="text" id="firstname" class="form-control"
                            :class="{ 'is-invalid': firstnameError || first_name == '' }" name="first_name"
                    ...
                    <div class="col-md-5 col-lg-4">
                        ...
                        <input type="text" id="lastname" class="form-control"
                            :class="{ 'is-invalid': lastnameError || last_name == '' }" name="last_name" v-model="last_name"
                ...
                <div class="row row-sm mb-3">
                    <div class="col-md-5 col-lg-4">
                        ...
                        <input type="email" id="email" class="form-control" name="email" v-model="email"
                            :class="{ 'is-invalid': emailError || email == '' }" placeholder="Enter email address" required>
                    </div>
                    <div class="col-md-5 col-lg-4">
                        <label for="password" class="form-label">Password: <span class="tx-danger">*</span></label>
                        <input type="text" id="password" class="form-control" name="password" v-model="password"
                            :class="{ 'is-invalid': passwordError || password == '' }" placeholder="Enter password" required>
                    </div>
                </div>
            </TabContent>
