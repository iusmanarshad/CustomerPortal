									...
									<div class="main-card-signin d-md-flex">
										<div class="wd-100p">
											...
											<div class="mt-1">
												...
												<h2 class="tx-medium tx-primary">Signup</h2>
												<h6 class="font-weight-semibold mb-4 text-muted">Please set a password bellow.</h6>
															...
															<div class="tab-pane active" id="signinTab1">
																<form action="{{ route('postSignup') }}" method="POST">
																	...
																	<div class="form-group">
																		<input class="form-control" name="email" id="email" value="{{ request('email') }}" placeholder="Email" type="email" readonly>
																	</div>
																	<div class="form-group">
                                                                    ...
                                                                    <input type="hidden" name="invited_by" value="{{ request('invited_by') }}">
