						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
                                ...
                                <li class="slide is-expanded">
                                    <a class="side-menu__item {{ request()->is('portal/announcements*') ? 'active' : '' }}" data-bs-toggle="slide" href="/portal/clients">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item {{ request()->is('portal/announcements*') ? 'active' : '' }}" data-bs-toggle="slide" href="/portal/announcements">
