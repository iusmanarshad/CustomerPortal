...
@section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">ABOUT US</span>
						</div>
                    ...
                    <div class="container">
						...
						<div class="row mb-3">
							<div class="col-xl-8 col-lg-12 col-sm-12">
								<h1 class="mb-3 font-weight-semibold tx-46">Hello! This is <span class="tx-primary tx-56">Zem.</span></h1>
								<p class="leading-normal lead-1">Majority have suffered alteration in some form.</p>
								<p class="leading-normal  tx-16">There are many variations of passages of Lorem Ipsum available, but the majority have suffered  by injected humour, or randomised words which don't look even slightly believable.
									If you are going to use a passage of Lorem Ipsum you are going to use a passage of Lorem Ipsum</p>
							</div>
						</div><!-- /row -->

						<!-- row -->
						<div class="row mb-3 br-5">
							<p class="bg-white p-2 radius-4"><img src="{{asset('build/assets/img/photos/27.jpg')}}" class="radius-7"  alt="image"></p>
						</div><!-- /row -->

						<!-- row -->
						<div class="row mb-2 p-xl-5 p-0">
							<div class="col-md-12">
								<div class="row justify-content-end">
									<div class="col-xl-4 ps-4 justify-self-start">
										<h5 class="text-dark tx-26 font-weight-semibold">Our Services</h5>
										<p class="tx-14 mb-4">Diam consetetur sed labore sea kasd</p>
									</div>
									<div class="col-xl-3">
										<div class="card">
											<div class="card-body tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-primary-transparent tx-primary mb-2"><i class="fe fe-layers tx-20"></i></span>
												<h5>Designing</h5>
												<p class="mb-0 tx-muted">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
									</div>
									<div class="col-xl-3">
										<div class="card">
											<div class="card-body tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-warning-transparent tx-warning mb-2"><i class="fe fe-code tx-20"></i></span>
												<h5>Developing</h5>
												<p class="mb-0 tx-muted">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
								...
								<div class="row flex-1 justify-content-center">
									<div class="col-xl-3">
										<div class="card">
											<div class="card-body tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-orange-transparent tx-orange mb-2"><i class="fe fe-globe tx-20"></i></span>
												<h5>Social Media</h5>
												<p class="mb-0 tx-muted">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
									...
									<div class="col-xl-3">
										<div class="card">
											<div class="card-body tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-green-transparent tx-green mb-2"><i class="fe fe-shopping-cart tx-20"></i></span>
												<h5>E-Commerce</h5>
												<p class="mb-0 tx-muted">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
						...
						<div class="row mb-2  p-xl-5 p-0">
							<div class="col-md-12">
								<div class="row justify-content-end mb-md-4">
									<div class="col-xl-5 ps-4 justify-self-start">
										<h5 class="text-dark tx-26 font-weight-semibold">Why Zem ?</h5>
										<p class="tx-14 tx-muted mb-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quibusdam similique provident Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus, aliquam voluptas repellat eum beatae veniam, cumque eligendi earum praesentium, in corrupti reprehenderit cum architecto quisquam? Quibusdam quaerat veritatis perferendis iusto. !</p>
									</div>
									<div class="col-xl-3">
										<div class="motto-icon mi_1 tx-white">
											<div class="card-body  tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-white-transparent tx-white mb-2"><i class="fe fe-check-circle tx-20"></i></span>
												<h5>Quality</h5>
												<p class="mb-0 op-6">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
									</div>
									<div class="col-xl-3">
										<div class="motto-icon mi_2 tx-white mt-4 mt-xl-0">
											<div class="card-body  tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-white-transparent tx-white mb-2"><i class="fe fe-shield tx-20"></i></span>
												<h5>Security</h5>
												<p class="mb-0 op-6">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
								...
								<div class="row flex-1 justify-content-center">
									<div class="col-xl-3">
										<div class="motto-icon mi_3 tx-white mt-4 mt-xl-0">
											<div class="card-body  tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-white-transparent tx-white mb-2"><i class="fe fe-edit-3 tx-20"></i></span>
												<h5>Customize</h5>
												<p class="mb-0 op-6">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
									...
									<div class="col-xl-3">
										<div class="motto-icon mi_4 tx-white mt-4 mt-xl-0">
											<div class="card-body  tx-center">
												<span class="avatar avatar-lg rounded-circle mx-auto bg-white-transparent tx-white mb-2"><i class="fe fe-box tx-20"></i></span>
												<h5>Advanced</h5>
												<p class="mb-0 op-6">Labore duo et at ea accusam. Et guberg  consetetur.</p>
											</div>
										</div>
							...
							<div class="col-md-12">
								<div class="card overflow-hidden">
									<div class="card-body">
										<div class="row">
											<div class="col-xl-3">
												<div class="counter-status p-4 md-mb-0">
													<div class="text-center mb-2">
														<svg class="about-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#38cab3" d="M10.3125,16.09375a.99676.99676,0,0,1-.707-.293L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328l-6.1875,6.1875A.99676.99676,0,0,1,10.3125,16.09375Z" opacity=".99"/><path fill="#87dfd1" d="M12,2A10,10,0,1,0,22,12,10.01146,10.01146,0,0,0,12,2Zm5.207,7.61328-6.1875,6.1875a.99963.99963,0,0,1-1.41406,0L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328Z"/></svg>
													</div>
													<div class="text-center">
														<h2 class="counter mb-2">256</h2>
														<h6 class="mb-0 tx-muted">Completed Projects</h6>
													</div>
												</div>
											</div>
											<div class="col-xl-3">
                        ...
                        <div class="row mb-5">
                                ...
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('build/assets/img/users/1.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Rosen Berg
                                        </div>
                                        <div class="tx-14 text-center tx-muted mb-3">
                                            Chief Manager
                                        </div>
										...
										<p class="text-center mb-0"><i class="fe fe-facebook tx-primary me-3"></i><i class="fe fe-instagram tx-secondary me-3"></i><i class="fe fe-globe tx-info me-3"></i></p>
									 </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('build/assets/img/users/2.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Mclaren mcannen
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('build/assets/img/users/3.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Shimpa Craig
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('build/assets/img/users/4.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Limo Peter
                                        </div>
