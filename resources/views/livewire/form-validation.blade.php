...
@section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">FORM VALIDATIONS</span>
						</div>
					...
					<div class="row">
									...
									<form class="row needs-validation" novalidate>
										...
										<div class="col-12">
											<div class="form-check">
												<input class="form-check-input custom-checkbox" type="checkbox" id="invalidCheck" required>
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Default Validation</div>
								</div>
								<div class="card-body">
									<form class="row">
										<div class="col-md-4">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Server Side Validation</div>
								</div>
								<div class="card-body">
									<form class="row">
										<div class="col-md-4">
								...
								<div class="card-body">
									<form class="was-validated">
										...
										<div class="input-group file-browser mb-3">
											...
											<label class="input-group-text btn btn-primary">Browse
												<input type="file" class="file-browserinput" style="display: none;" multiple>
											</label>
										</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<form class="row needs-validation" novalidate>
										...
										<div class="col-md-3 position-relative">
											<label for="validationTooltip05" class="form-label">Zip Code</label>
