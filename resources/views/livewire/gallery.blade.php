...
@section('content')
					...
					<div class="masonry row">
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="brick">
								<a href="{{asset('build/assets/img/photos/7.jpg')}}" class=" js-img-viewer" data-caption="IMAGE-07"
									data-id=" rhino">
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="brick">
								<a href="{{asset('build/assets/img/photos/8.jpg')}}" class=" js-img-viewer" data-caption="IMAGE-08"
									data-id=" rhino">
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="brick">
								<a href="{{asset('build/assets/img/photos/9.jpg')}}" class=" js-img-viewer" data-caption="IMAGE-09"
									data-id=" rhino">
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="brick">
								<a href="{{asset('build/assets/img/photos/10.jpg')}}" class=" js-img-viewer" data-caption="IMAGE-10"
									data-id=" rhino">
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="brick">
								<a href="{{asset('build/assets/img/photos/11.jpg')}}" class=" js-img-viewer" data-caption="IMAGE-11"
									data-id=" rhino">
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="brick">
								<a href="{{asset('build/assets/img/photos/17.jpg')}}" class=" js-img-viewer" data-caption="IMAGE-11"
									data-id=" rhino">
									<img src="{{asset('build/assets/img/photos/17.jpg')}}" alt="" />
								</a>
							</div>
						</div>
					</div>
