...
@section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">BOOTSTRAP ICONS</span>
						</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="col-lg-12 col-sm-12 mb-2">
									<h5 class="mb-2">Bootstrap icons</h5>
									<p class="mb-2 tx-muted">Powered by Font Awesome set. For more info <a href="https://icons.getbootstrap.com/" target="_blank" class="tx-primary">click here</a>.</p>
