...
@section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">TYPICONS</span>
						</div>
								...
								<div class="card-body">
									<div class="row row-sm">
										<div class="col-lg-12 col-sm-12 mb-2">
											<h5 class="mb-2">Typicons icons</h5>
											<p class="mb-2 tx-muted">Simply beautiful open source icons. For more info <a href="https://www.s-ings.com/typicons/" target="_blank" class="tx-primary">click here</a>.</p>
