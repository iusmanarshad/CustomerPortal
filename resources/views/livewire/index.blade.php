									...
									<div class="card-body py-0 px-3">
										<div class="row">
											<div class="col-xxl-3 col-xl-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-between flex-wrap border-primary-end p-4">
												<div>
													<p class="tx-primary tx-12 mb-1">Total Profit</p>
													<h4 class="tx-22 numberfont font-weight-semibold mb-1">$8,943.00</h4>
													<p class="tx-11 tx-muted mb-0">Current Month</p>
												</div>
											...
											<div class="col-xxl-3 col-xl-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-between flex-wrap border-primary-end p-4">
												<div>
													<p class="tx-primary tx-12 mb-1">Total Orders</p>
													<h4 class="tx-22 numberfont font-weight-semibold mb-1">5,472.00</h4>
													<p class="tx-11 tx-muted mb-0">Current Month</p>
												</div>
												<div class="flex-center">
											...
											<div class="col-xxl-3 col-xl-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-between flex-wrap border-primary-end p-4">
												<div>
													<p class="tx-primary tx-12 mb-1">Total Sales</p>
													<h4 class="tx-22 numberfont font-weight-semibold mb-1">4,406.00</h4>
													<p class="tx-11 tx-muted mb-0">Current Month</p>
												</div>
												<div class="flex-center">
											...
											<div class="col-xxl-3 col-xl-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-between flex-wrap ps-4 py-4 pe-2">
												<div class="flex-grow-1">
													<p class="tx-primary tx-12 mb-1">Total Investment</p>
													<h4 class="tx-22 numberfont font-weight-semibold mb-1">$34K <span
													class="badge badge-success-transparent tx-success tx-11">56<i
														class="fe fe-arrow-up tx-11"></i></span></h4>
													<p class="tx-11 tx-muted mb-0">Current Month</p>
												</div>
										...
										<ul class="ps-0 list-unstyled mb-0">
											...
											<li class="mb-4">
												<div class="d-flex justify-content-between ms-4 activity-content2">
													<p class="mb-1 wd-250">
														Neon Tarly <span class="tx-11 font-weight-normal">added</span> <span class="text-secondary">Robin Bright</span> <span class="tx-11 font-weight-normal">to the</span> Summit AI <span class="tx-11 font-weight-normal">Project.</span>
													</p>
											...
											<li class="mb-0">
												<div class="d-flex justify-content-between ms-4 activity-content7">
													<p class="mb-1 wd-250">
														Neon Tarly <span class="tx-11 font-weight-normal">added</span> <span class="tx-orange">Robin Bright</span> <span class="tx-11 font-weight-normal">to the</span> Summit AI <span class="tx-11 font-weight-normal">Project.</span>
													</p>
													<span class="tx-11 tx-muted">6h</span>
												</div>
											</li>
												...
												<table class="table border-0 mb-0">
													...
													<tbody>
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/32.png')}}" alt="img"
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/34.png')}}" alt="img"
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/33.png')}}" alt="img"
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/37.png')}}" alt="img"
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/35.png')}}" alt="img"
																		class="radius-4 avatar p-2 bg-primary-transparent">
																	<div class="d-flex flex-column ms-2">
												...
												<table class="table border-0 mb-0">
													...
													<tbody>
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/7.jpg')}}" alt="img"
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/18.jpg')}}" alt="img"
																		class="radius-4 avatar">
																	<div class="d-flex flex-column ms-2">
																		<P class="mb-1">WATCH Blue</P>
																		<span class="tx-muted tx-12">
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/19.jpg')}}" alt="img"
																		class="radius-4 avatar">
																	<div class="d-flex flex-column ms-2">
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/20.jpg')}}" alt="img"
																		class="radius-4 avatar">
																	<div class="d-flex flex-column ms-2">
														...
														<tr>
															<td class="ps-4">
																<div class="d-flex align-items-center">
																	<img src="{{asset('build/assets/img/ecommerce/6.jpg')}}" alt="img"
																		class="radius-4 avatar">
																	<div class="d-flex flex-column ms-2">
					...
					<div class="col-xl-12 col-xxl-3">
						<div class="row">
												...
												<div class="d-flex align-items-center">
													...
													<div class="ms-3 flex-1">
														<div class="d-flex align-items-center justify-content-between">
															...
															<span class="badge badge-primary-transparent"><i class="fe fe-arrow-right tx-10 me-2 d-inline-flex"></i>10.06.2020</span>
														</div>
												...
												<div class="d-flex align-items-center">
													...
													<div class="ms-3 flex-1">
														<div class="d-flex align-items-center justify-content-between">
															...
															<span class="badge badge-secondary-transparent"><i class="fe fe-arrow-right tx-10 me-2 d-inline-flex"></i>02.06.2022</span>
														</div>
														<p class="tx-muted mb-0 tx-11 d-flex align-items-center">2m ago
															<span class="ms-2 d-flex align-items-center"> <span
												...
												<div class="d-flex align-items-center">
													...
													<div class="ms-3 flex-1">
														<div class="d-flex align-items-center justify-content-between">
															...
															<span class="badge badge-warning-transparent"><i class="fe fe-arrow-right tx-10 me-2 d-inline-flex"></i>06.12.2022</span>
														</div>
														<p class="tx-muted mb-0 tx-11 d-flex align-items-center">2m ago
															<span class="ms-2 d-flex align-items-center"> <span
											...
											<li>
												<div class="d-flex align-items-center">
													...
													<div class="ms-3 flex-1">
														<div class="d-flex align-items-center justify-content-between">
															<p class="mb-0">To Do</p>
															<span class="badge badge-success-transparent"><i class="fe fe-arrow-right tx-10 me-2 d-inline-flex"></i>12.06.2021</span>
														</div>
														<p class="tx-muted mb-0 tx-11 d-flex align-items-center">2m ago
															<span class="ms-2 d-flex align-items-center"> <span
							...
							<div class="col-md-12">
								<div class="card ">
									<div class="card-header d-flex justify-content-between align-items-center">
										<div class="card-title d-flex justify-content-between me-2 me-xxl-0">
											Billings
										</div>
										<div class="panel">
										...
										<tbody>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/22.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/16.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
														<a href="{{url('product-details')}}">Sed vero et ipsum et</a>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/20.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/18.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/7.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/11.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/17.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/21.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
														<a href="{{url('product-details')}}">Diam voluptua stet invidunt
															sed</a>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="avatar avatar-sm me-2">
															<img src="{{asset('build/assets/img/ecommerce/9.jpg')}}" alt="avatar"
																class="br-5 shadow">
														</div>
